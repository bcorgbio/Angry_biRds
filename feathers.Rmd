...
### Methods
#### Image Acquisition 
Images analyzed in this project were acquired through the U.S. Fish & Wildlife Service’s database: “Feather Atlas”. Records from the Feather Atlas are accessible for all Avians further analyzed below. 
...
PCA plot output for primary feathers can be referenced below (Figures 2 & 3). Evolutionary rates of the PC scores were observed across the Avian tree [@jetz2012global] and species information was added (Figure 1). 
